...
export const requestURLs = {
  ...
  adminPortfolioDashboardData: `${baseURL}/dashboard/administartorProjects`,
  managerPortfolioDashboardData: `${baseURL}/dashboard/projectManagerProjects`,
  projectDashboardData: `${baseURL}/dashboard/dashboardByProjectId`,
};
