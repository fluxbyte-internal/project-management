...
CREATE TABLE `Organisation` (
    ...
    UNIQUE INDEX `Organisation_organisation_name_industry_created_by_user_id_key`(`organisation_name`, `industry`, `created_by_user_id`),
...
CREATE TABLE `Project` (
    ...
    `estimated_budget` VARCHAR(191) NOT NULL,
