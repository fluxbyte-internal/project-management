...
import useConsoleUserProfileUpdateMutation from "@/api/mutation/useUserProfileUpdateMutation";
...
function AccountSettings() {
  ...
  const userProfileUpdateMutation = useConsoleUserProfileUpdateMutation();
  ...
  const [isJobTitleSubmitting] = useState(false);
