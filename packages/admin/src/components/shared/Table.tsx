...
function Table(props: Props) {
  ...
  return (
    <>
      <div
        ref={table}
        className={`py-9 pb-3 flex flex-col justify-between bg-white px-6 border rounded-md text-sm h-full w-full ${className ?? ""
          }`}
      >
                          ...
                          {item.sorting ? (
                            <>
                              ...
                              >
                                ...
                                <img
                                  src={downArrow}
                                  className={`${!ascendingToggle ? "rotate-180" : ""
                    ...
                    {accordions === index && (
                      <tr>
                        <td colSpan={columnDef?.length}>
                          <div
                            className={`rounded-xl flex justify-center ${props.onAccordionRender &&
